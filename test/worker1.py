...
def main():
    worker_id = 'worker1'  # Replace 'worker1' with 'worker2' or 'worker3' for other workers
    worker_data = load_worker_data('try1.json')  # Replace 'try1.json' with the correct file for each worker
